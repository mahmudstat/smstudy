...
Officious, obtain (to be valid), evanescent, concomitant, modicum
...
<span
  onmouseover="document.getElementById('tip1').style.display='inline';"
  onmouseout="document.getElementById('tip1').style.display='none';"
  style="text-decoration: underline; cursor: help;">
  Sardonic
</span>
<span
  id="tip1"
  style="display:none; background: #333; color: white; padding: 4px 8px; border-radius: 4px; position: absolute; z-index: 100;">
  Mocking or cynical, often in a scornful manner
</span>
